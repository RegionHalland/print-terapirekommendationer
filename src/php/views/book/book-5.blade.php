...
<head>
    <meta charset="utf-8">
    <title></title>
    <link rel="stylesheet" type="text/css" href="{{ PRINT_TR_PLUGIN_URL }}/dist/css/print-a5.min.css?ver=1.0">
</head>
<body>
    ...
    <main class="main" role="main">
        <div>
            ...
            <div class="chapter-header-left"></div>
            <div class="chapter-header-right"></div>
        </div>
    </main>
    {{-- Foreword END --}}
